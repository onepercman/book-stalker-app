...
function Toast({ id, message, onHide, variant = "default", duration = 3000, showProgress = true }: ToastProps) {
...
function ToastProvider({ children, position = "top" }: { children: React.ReactNode; position?: "top" | "bottom" }) {
