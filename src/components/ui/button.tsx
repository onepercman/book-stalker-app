...
function Button({
  ...
  return (
    ...
    >
      ...
      {leftIcon ? (
        <Text className={cn(buttonTextVariants({ variant, size, className: labelClasses }))}>{leftIcon}</Text>
      ) : null}
      {children ? (
        <Text className={cn(buttonTextVariants({ variant, size, className: labelClasses }))}>{children}</Text>
      ) : null}
      {rightIcon ? (
        <Text className={cn(buttonTextVariants({ variant, size, className: labelClasses }))}>{rightIcon}</Text>
      ) : null}
    </TouchableOpacity>
  )
}
